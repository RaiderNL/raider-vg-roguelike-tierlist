...
/*
 * URL видео берётся только из основной таблицы игр.
 *
 * "Video Type" — это заголовок служебной таблицы справа
 * на том же листе, поэтому использовать его здесь нельзя:
 * данные из той же строки иначе ошибочно приклеиваются
 * к игре слева.
 */
...
/*
 * Название ролика хранится в основной левой таблице.
 *
 * "Title" справа — служебная колонка таблицы соответствия,
 * поэтому она не должна использоваться как fallback.
 */
